...
# Script to test ET2FA with different workflow sizes
...
test_workflow() {
    ...
    mvn exec:java -Dexec.mainClass="vn.et2fa.App" \
        ...
        -q 2>&1 | grep -E "(ET2FA:|DAG Simplify:|Topological Levels:|DOBS:|=== Scheduling Results ===|=== Performance Metrics ===|Total Cost:|Total Idle Rate:|Meets Deadline:|Max Finish Time:|ERROR|WARNING)" | head -30
